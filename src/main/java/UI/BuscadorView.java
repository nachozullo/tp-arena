...
public class BuscadorView extends MainWindow<Buscador> {
	...
	public void createContents(Panel mainPanel) {
		...
		new Button(mainPanel).setCaption("Buscar").onClick(() -> this.getModelObject().buscarEstudiante()).setAsDefault();
	...
	public static void main(String[] args) {
		Estudiante mole = new Estudiante("Agustin", "Mole", 123, "moleputo");
